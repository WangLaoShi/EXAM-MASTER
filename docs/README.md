...
- [ACTIVATION_CODE_SYSTEM.md](../backend/docs/ACTIVATION_CODE_SYSTEM.md) — 激活码系统
- [MCP_INTEGRATION.md](../backend/docs/MCP_INTEGRATION.md) — MCP 集成
- [VIDEO_SUPPORT.md](../backend/docs/VIDEO_SUPPORT.md) / [MEDIA_PREVIEW_AND_ACCESS.md](../backend/docs/MEDIA_PREVIEW_AND_ACCESS.md) — 媒体资源
- [INSERT_RESOURCE_FEATURE.md](../backend/docs/INSERT_RESOURCE_FEATURE.md) — 资源插入
- [CUSTOM_MODEL_GUIDE.md](../backend/docs/CUSTOM_MODEL_GUIDE.md) — 自定义模型配置
...
- [ICON_README.md](guides/ICON_README.md) — 应用图标说明

## 历史归档 (`docs/archive/`)

开发过程中的会话记录、Bug 修复报告、一次性部署说明等中间文档已移至归档目录，供查阅历史上下文，**不作为当前开发参考**：

- `archive/sessions/` — 开发会话与进度记录
- `archive/fixes/` — Bug 修复与部署记录
- `archive/reports/` — 探索报告、兼容性检查、测试报告
